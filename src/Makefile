...
OFILES = main.o myLib.o font.o writeText.o startLevel.o gameover.o youWin.o scorePic.o game.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = writeText.h myLib.h startLevel.h gameover.h youWin.h scorePic.h game.h
